...
4. **CNC** (if ``cnc/cnc_torus.txt`` exists) — external curvature data.
...
Usage::
    ...
    python analytic_manifold.py --k-bu 25 --k-jet 25
...
def _show_polyscope(pts, normals, gt, methods):
...
def main():
    ...
    jf = _jet_curvature_all(pts, normals, k=args.k_jet, degree=args.degree)
    ...
    if not args.no_polyscope:
        _show_polyscope(pts, normals, gt, methods)
